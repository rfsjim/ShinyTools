...
public class ModTags {
	...
	private static ITag.INamedTag<Block> mod(String path) {
			return BlockTags.makeWrapperTag(new ResourceLocation(shinytools.MOD_ID, path).toString());
		}
	}
	...
	public static final class Items {
		...
		private static ITag.INamedTag<Item> mod(String path) {
			return ItemTags.makeWrapperTag(new ResourceLocation(shinytools.MOD_ID, path).toString());
		}
	}
}
